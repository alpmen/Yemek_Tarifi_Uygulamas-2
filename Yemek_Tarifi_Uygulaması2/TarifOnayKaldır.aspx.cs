...
{
    public partial class TarifOnayKaldır : System.Web.UI.Page
    {
        ...
        {
            SqlCommand komut = new SqlCommand("update Tbl_Tarifler set TarifDurum=0 where Tarifid=@p1", bgl.baglan());
            komut.Parameters.AddWithValue("@p1", Convert.ToInt32(Tarifid));
            komut.ExecuteNonQuery();
            bgl.baglan().Close();
            Response.Write("Tarif Onay Kaldırıldı");
        }
    }
}