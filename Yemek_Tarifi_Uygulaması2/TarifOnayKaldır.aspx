<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="TarifOnayKaldır.aspx.cs" Inherits="Yemek_Tarifi_Uygulaması2.TarifOnayKaldır" %>
        ...
        <asp:Panel ID="Panel2" runat="server">
            <table class="auto-style4">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td><strong>
                        <asp:Button ID="Button1" runat="server" CssClass="auto-style7" OnClick="Button1_Click" Text="ONAY KALDIR" />
                        </strong></td>
                </tr>
            </table>
        </asp:Panel>
